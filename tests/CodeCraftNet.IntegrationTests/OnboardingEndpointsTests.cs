...
using CodeCraftNet.Application.Features.Identity;
...
public sealed class OnboardingEndpointsTests(CodeCraftNetApiFactory factory) : IClassFixture<CodeCraftNetApiFactory>
{
