...
/// </summary>
public class CodeCraftNetApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            services.RemoveAll<DbContextOptions<CodeCraftNetDbContext>>();
            services.RemoveAll<DbContextOptions>();

            _connection.Open();
            services.AddDbContext<CodeCraftNetDbContext>(options => options.UseSqlite(_connection));
