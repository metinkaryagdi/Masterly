...
using CodeCraftNet.Application.Features.StudyPlans;
using CodeCraftNet.Application.Features.Topics;
...
namespace CodeCraftNet.IntegrationTests;

public sealed class StudyPlanEndpointsTests(CodeCraftNetApiFactory factory) : IClassFixture<CodeCraftNetApiFactory>
{
