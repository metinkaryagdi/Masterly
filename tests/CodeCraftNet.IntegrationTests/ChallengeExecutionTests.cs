...
public sealed class StubRunnerApiFactory : CodeCraftNetApiFactory
{
...
public sealed class ChallengeExecutionDisabledTests(CodeCraftNetApiFactory factory) : IClassFixture<CodeCraftNetApiFactory>
{
    [Fact]
