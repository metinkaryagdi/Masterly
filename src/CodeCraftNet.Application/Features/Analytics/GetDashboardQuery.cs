...
namespace CodeCraftNet.Application.Features.Analytics;
...
public sealed class GetDashboardQueryHandler(ICodeCraftNetDbContext dbContext) : IQueryHandler<GetDashboardQuery, AnalyticsDashboardDto>
{
