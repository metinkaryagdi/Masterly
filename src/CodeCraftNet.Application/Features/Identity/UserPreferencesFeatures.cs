...
public sealed class GetUserPreferencesQueryHandler(ICodeCraftNetDbContext dbContext)
...
public sealed class UpdateUserPreferencesCommandHandler(ICodeCraftNetDbContext dbContext, IClock clock)
