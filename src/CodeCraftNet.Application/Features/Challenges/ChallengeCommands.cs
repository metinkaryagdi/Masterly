...
using CodeCraftNet.Application.Common.Persistence;
...
{
    public static async Task EnsureTopicExists(Guid topicId, ICodeCraftNetDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    public static async Task EnsureUserAndChallengeExist(Guid userId, Guid codingChallengeId, ICodeCraftNetDbContext dbContext, CancellationToken cancellationToken)
    {
